...
class OrderServiceImplTest {
    ...
    @Test
    void testFindAllByAuthorIfAuthorNotFound() {
        doReturn(new ArrayList<Order>()).when(orderRepository).findAllByAuthor("Bambang Sudrajat");

        List<Order> results = orderService.findAllByAuthor("Bambang Sudrajat");
